...
public class ProductServiceTest {
    ...
    public void testFindAll_RetornaProductos() {
        ...
        Product p1 = new Product(1L, "GPU", "Nvidia", "RTX 4070", "GPU", 700.0, 10, 1L);
        Product p2 = new Product(2L, "CPU", "AMD", "Ryzen 7", "CPU", 400.0, 5, 1L);
    ...
    public void testSave_GuardaProducto() {
        ...
        Product nuevo = new Product(null, "RAM", "Corsair", "Vengeance", "RAM", 150.0, 20, 1L);
    ...
    public void testFindById_ProductoExiste() {
        ...
        Product producto = new Product(1L, "SSD", "Samsung", "980 Pro", "Storage", 200.0, 15, 1L);
    ...
    public void testReduceStock_ExitoConStockSuficiente() {
        ...
        Product producto = new Product(1L, "GPU", "Asus", "X", "GPU", 100.0, 10, 1L);
        when(productRepository.findById(1L)).thenReturn(Optional.of(producto));
    ...
    public void testReduceStock_DescontarTodoElStock() {
        ...
        Product producto = new Product(1L, "GPU", "Asus", "X", "GPU", 100.0, 5, 1L);
        when(productRepository.findById(1L)).thenReturn(Optional.of(producto));
        when(productRepository.save(any(Product.class))).thenAnswer(i -> i.getArguments()[0]);
    ...
    public void testReduceStock_StockInsuficiente_LanzaExcepcion() {
        ...
        Product producto = new Product(1L, "GPU", "Asus", "X", "GPU", 100.0, 2, 1L);
        when(productRepository.findById(1L)).thenReturn(Optional.of(producto));
